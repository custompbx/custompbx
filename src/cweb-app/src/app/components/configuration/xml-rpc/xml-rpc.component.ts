...
} from '../../../store/config/xml_rpc/config.actions.xml_rpc';
...
export class XmlRpcComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.configs$ = this.configs.subscribe((configs) => {
      ...
      this.list = configs.xml_rpc;
      this.lastErrorMessage = configs.xml_rpc && configs.xml_rpc.errorMessage || null;
