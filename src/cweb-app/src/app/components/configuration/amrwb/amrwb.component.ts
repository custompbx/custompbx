...
} from '../../../store/config/amrwb/config.actions.amrwb';

@Component({
  selector: 'app-amrwb',
  templateUrl: './amrwb.component.html',
  styleUrls: ['./amrwb.component.css']
})
export class AmrwbComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.configs$ = this.configs.subscribe((configs) => {
      ...
      this.list = configs.amrwb;
      this.lastErrorMessage = configs.amrwb && configs.amrwb.errorMessage || null;
