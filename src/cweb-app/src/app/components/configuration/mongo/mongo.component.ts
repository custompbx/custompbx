...
} from '../../../store/config/mongo/config.actions.mongo';
...
export class MongoComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.configs$ = this.configs.subscribe((configs) => {
      ...
      this.list = configs.mongo;
      this.lastErrorMessage = configs.mongo && configs.mongo.errorMessage || null;
